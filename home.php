<?php 
// include 'admin/db_connect.php';  meee 
?>
<style>
#portfolio .img-fluid{
    width: calc(100%);
        ...
        <header class="masthead">
            <div class="container-fluid h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    ...
                    <h3 class="text-white">Welcome to 	<!-- <?php echo $_SESSION['system']['name']; ?>  mee -->
                    </h3>
            ...
            <div class="container mt-3 pt-2">
                ...
                <hr class="divider">
                <?php
            // me    $event = $conn->query("SELECT e.*,v.venue FROM events e inner join venue v on v.id=e.venue_id where date_format(e.schedule,'%Y-%m%-d') >= '".date('Y-m-d')."' and e.type = 1 order by unix_timestamp(e.schedule) asc");
